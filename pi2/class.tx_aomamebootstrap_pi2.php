 ...
 */
class tx_aomamebootstrap_pi2 extends tslib_pibase {
	public $prefixId      = 'tx_aomamebootstrap_pi2';		// Same as class name
	public $scriptRelPath = 'pi2/class.tx_aomamebootstrap_pi2.php';	// Path to this script relative to the extension dir.
	...
	private function configuration(){
		...
		$getTabHtmlId = $this->pi_getFFvalue($this->cObj->data['pi_flexform'], 'tabhtmlid', 'sDEF');
		...
		$getActiveTab = $this->pi_getFFvalue($this->cObj->data['pi_flexform'], 'activetab', 'sDEF');
